...
execute if score @s weight_ratio matches 10..12 run function equipment_weight:training/light
execute if score @s weight_ratio matches 13..15 run function equipment_weight:training/normal
execute if score @s weight_ratio matches 16..19 run function equipment_weight:training/heavy

# too heavy → injury
execute if score @s weight_ratio matches 20.. run function equipment_weight:training/injury
...
# progression bar
scoreboard players operation @s training_bar = @s training_ratio
scoreboard players operation @s training_bar /= #w10 weight_multi
